...
describe "Merchants API", type: :request do
  ...
  it "can display the merchants with the most total revenue based on user request" do
    headers = {"CONTENT_TYPE" => "application/json"}
    params = {"quantity" => "3"}

    get "/api/v1/merchants/most_revenue", headers: headers, params: params
  ...
  it "will display the merchants with the most total revenue based on user request, but can only return as many as exist" do
    headers = {"CONTENT_TYPE" => "application/json"}
    params = {"quantity" => "5"}
  ...
  it "will display the merchants with the most total revenue based on user request" do
    headers = {"CONTENT_TYPE" => "application/json"}
    params = {"quantity" => "2"}
